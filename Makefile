broker-up:
	@docker-compose up --remove-orphans -d mqtt mqtt-panel

broker-down:
	@docker-compose stop mqtt mqtt-panel
...
simulation-up: broker-up device-up

simulation-down: broker-down device-down
